...
export const ASK_SALES_FAQ_POLICY_RULES: {
  ...
  answerRules: [
    ...
    },
    {
      ...
      match_any: ["refund window", "istv clients get a refund", "clients get a refund"],
    },
    {
      ...
      match_any: ["where do all tiers air", "isn app", "apple tv", "amazon prime", "work directly with amazon", "work directly with apple", "leads or roi", "roi", "business results"],
    },
    {
    ...
    },
    {
      ...
      match_any: ["custom payment plan", "custom payment link", "different amount", "card details", "raw card", "client card", "paste it in slack"],
    },
    {
      ...
      match_any: ["internal slack screenshot", "training video", "internal materials"],
    },
    {
      ...
      match_any: ["hosted on the istv platform", "license rights", "episode stays on istv forever", "stays on istv forever"],
    },
    {
      ...
      match_any: ["recorded automatically", "access a call recording", "sales calls recorded"],
    },
  ],
};
